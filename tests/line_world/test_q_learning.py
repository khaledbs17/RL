...
def test_q_learning():
    ...
    agent.save(r'D:\projet_DRL - Copie\tests\line_world\policy\q_learning_policy.npz')
    print("Politique et fonctions sauvegardées dans 'q_learning_policy.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL - Copie\tests\line_world\policy\q_learning_policy.npz')
