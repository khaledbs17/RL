...
def test_off_policy_mcc():
    ...
    agent.save(r'D:\projet_DRL - Copie\tests\line_world\policy\off_policy_mcc_policy.npz')
    print("Politique et fonctions sauvegardées dans 'off_policy_mcc_policy.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL - Copie\tests\line_world\policy\off_policy_mcc_policy.npz')
