...
def test_policy_iteration():
    ...
    agent.save(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_1\policy\policy_iteration_MH1.npz')
    print("Politique et fonctions sauvegardées dans 'policy_iteration_MH1.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_1\policy\policy_iteration_MH1.npz')
