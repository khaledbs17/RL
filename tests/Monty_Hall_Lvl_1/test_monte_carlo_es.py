...
def test_monte_carlo_es():
    ...
    agent.save(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_1\policy\monte_carlo_es_policy_MH1.npz')
    print("Politique et fonctions sauvegardées dans 'monte_carlo_es_policy_MH1.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_1\policy\monte_carlo_es_policy_MH1.npz')
