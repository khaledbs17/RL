...
def test_q_learning():
    ...
    agent.save(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_1\policy\q_learning_policy_MH1.npz')
    print("Politique et fonctions sauvegardées dans 'q_learning_policy_MH1.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_1\policy\q_learning_policy_MH1.npz')
