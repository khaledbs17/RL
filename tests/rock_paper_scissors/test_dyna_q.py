...
def test_dyna_q():
    ...
    agent.save(r'D:\projet_DRL\tests\rock_paper_scissors\policy\dyna_q_policy_rps.npz')
    logging.info("Politique et fonctions sauvegardées dans 'dyna_q_policy_rps.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL\tests\rock_paper_scissors\policy\dyna_q_policy_rps.npz')
