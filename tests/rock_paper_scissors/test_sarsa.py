...
def test_sarsa():
    ...
    agent.save(r'D:\projet_DRL\tests\rock_paper_scissors\policy\sarsa_policy_rps.npz')
    logging.info("Politique et fonctions sauvegardées dans 'sarsa_policy_rps.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL\tests\rock_paper_scissors\policy\sarsa_policy_rps.npz')
