...
def test_q_learning():
    ...
    agent.save(r'D:\projet_DRL\tests\rock_paper_scissors\policy\q_learning_policy_rps.npz')
    ...
    agent.load(r'D:\projet_DRL\tests\rock_paper_scissors\policy\q_learning_policy_rps.npz')
