...
def test_off_policy_mcc():
    ...
    agent.save(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_2\policy\off_policy_mcc_MH2.npz')
    print("Politique et fonctions sauvegardées dans 'off_policy_mcc_MH2.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_2\policy\off_policy_mcc_MH2.npz')
