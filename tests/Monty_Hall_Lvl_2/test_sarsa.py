...
def test_sarsa():
    ...
    agent.save(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_2\policy\sarsa_policy_MH2.npz')
    print("Politique et fonctions sauvegardées dans 'sarsa_policy_MH2.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_2\policy\sarsa_policy_MH2.npz')
