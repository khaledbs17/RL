...
def test_on_policy_first_visit_mcc():
    ...
    agent.save(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_2\policy\on_policy_first_visit_MH2.npz')
    print("Politique et fonctions sauvegardées dans 'on_policy_first_visit_MH2.npz'.")

    # Chargement de la politique et des fonctions
    agent.load(r'D:\projet_DRL - Copie\tests\Monty_hall_Lvl_2\policy\on_policy_first_visit_MH2.npz')
